...
### Enjeux critiques. Le sujet et la machine...
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
<!-- .slide: data-background-video="img/albertine_meunier_google_search_history_2011_5.webm" -->

## L'usager numérique : un être de données ? La quantification du récepteur
...
===
Exemple :  Vous serez surpris par tout ce que vos tweets peuvent révéler de vous et de vos habitudes

Comme tous les réseaux sociaux, Twitter sait beaucoup de choses sur vous, grâce aux métadonnées. En effet, pour un message de 140 caractères, vous générez un ensemble de métadonnées faisant 20 fois la taille du contenu initial que vous avez saisi ! Et vous savez quoi ? Presque toutes les métadonnées sont accessibles par l’API ouverte de Twitter.
...
## Une écriture profilaire : le sujet formaté
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
<!-- .slide: data-background-image="img/regnault-dibutade.jpg" data-background-size="contain" -->
...
Forme évocatrice en soi, le profil un d'abord objet propre au domaine de la représentation visuelle qui qualifie un portrait de côté, une esquisse des contours, une figure ou un visage à moitié montré — et donc à moitié caché. Étroitement associée au mythe des origines de l’art — celui de Dibutade — la forme de profil s’inscrit dans une longue et riche tradition artistique. On citera notamment l'art de la silhouette - étudié par l'historien Georges Vigarello pour qui son apparition au XVIIIe coïncide avec l’émergence de l’individualité : la silhouette est ce qui fait de nous quelqu'un d'unique : "L’état de la silhouette est quasiment aujourd’hui une valeur : une présentation spécifique de soi."

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
<!-- .slide: data-background-image="img/bertillon.jpg" data-background-size="contain" -->



===

Au XIXe, le profil est directement associé à la construction du concept d'identité moderne, au prix d'un glissement intéressant de la notion (qui prend déjà la connotation de surveillance), à travers le bertillonage. Emprunté une première fois dans les années 1920 par la psychanalyse, le terme vient ensuite désigner, selon un sens figuré aujourd’hui passé dans l’usage courant, les principaux traits caractéristiques d’un individu. Plus récemment, le profil renvoie à nos compétences, et fait l'objet de recherches attentives de la part des recruteurs et RH.

Depuis quelques années enfin, le profil d’usager est devenu l’un des piliers du web participatif, grâce aux réseaux comme Facebook ou Twitter, même si le profil numérique se manifeste sous bien d’autres formes en dehors des médias sociaux.
...
## Comment réconcilier ses identités numériques et non-numériques ?
